...
//         feature:     i.feature    ?? '',
//         text:        i.message    ?? '',
//         score:       parseFloat(i.anomalyScore) || 0, // Dùng cho biểu đồ
//       }))
//     : buildFallbackInsights(transaction, behaviorScore);

//   // 🚀 TẠO DATA CHO BIỂU ĐỒ MẠNG NHỆN (RADAR CHART)
//   // Chuyển đổi Z-Score (0 -> 3+) thành thang điểm (0 -> 100) cho biểu đồ
//   const radarData = useMemo(() => {
//     const defaultData = [
//       { subject: 'SỐ TIỀN', A: 0, fullMark: 100 },
//       { subject: 'THỜI GIAN', A: 0, fullMark: 100 },
//       { subject: 'TẦN SUẤT', A: 0, fullMark: 100 },
//       { subject: 'NGƯỜI NHẬN', A: 0, fullMark: 100 },
//     ];

//     // Nếu dùng Fallback (chưa có insights thật), radar sẽ trống
//     if (rawInsights.length === 0) return defaultData;

//     insights.forEach(ins => {
//       // Công thức Map Z-Score: Z=3.0 sẽ tương đương kịch trần 100% rủi ro trên biểu đồ
//       let normalizedScore = Math.min((ins.score / 3.0) * 100, 100);
      
//       if (ins.feature === 'AMOUNT') defaultData[0].A = normalizedScore;
//       if (ins.feature === 'TIME') defaultData[1].A = normalizedScore;
//       if (ins.feature === 'FREQUENCY') defaultData[2].A = normalizedScore;
//       if (ins.feature === 'RECIPIENT') defaultData[3].A = normalizedScore;
//     });
...
//       {/* Lớp overlay click để đóng */}
//       <div className="absolute inset-0" onClick={onClose} />

//       <div className="relative bg-white rounded-[2rem] w-full max-w-5xl shadow-2xl flex flex-col max-h-[95vh] overflow-hidden animate-fade-in">
...
//           <button
//             onClick={onClose}
//             className="w-10 h-10 flex items-center justify-center rounded-full bg-slate-50 hover:bg-rose-50 text-slate-400 hover:text-rose-500 transition-all border border-transparent hover:border-rose-100"
//           >
...
//         {/* 🚀 CHIA ĐÔI MÀN HÌNH: TRÁI (THÔNG TIN & LUẬT TĨNH) - PHẢI (BIỂU ĐỒ & AI) */}
//         <div className="flex-1 overflow-y-auto hide-sb flex flex-col lg:flex-row bg-slate-50/50">
          
//           {/* 🟦 CỘT TRÁI: DỮ LIỆU SỐ & RULES */}
//           <div className="lg:w-5/12 p-6 border-r border-slate-100 space-y-6">
...
//           {/* 🟪 CỘT PHẢI: BIỂU ĐỒ AI VÀ PHÂN TÍCH */}
//           <div className="lg:w-7/12 p-6 space-y-6 bg-white">
...
//                 Đo lường độ lệch Mahalanobis
//               </h5>
//               <span className="text-xs font-bold text-slate-500 bg-slate-100 px-2 py-1 rounded-lg">
//                 Điểm Hành vi: {behaviorScore}/100
//               </span>
//             </div>

//             {/* 🚀 BIỂU ĐỒ RADAR (MẠNG NHỆN) */}
//             <div className="bg-slate-900 rounded-3xl p-2 flex items-center justify-center h-[300px] shadow-xl relative overflow-hidden">
//               {/* Lưới nền trang trí */}
...
//                   <PolarAngleAxis dataKey="subject" tick={{ fill: '#e2e8f0', fontSize: 11, fontWeight: '900', letterSpacing: '1px' }} />
//                   <PolarRadiusAxis angle={30} domain={[0, 100]} tick={false} axisLine={false} />
//                   <ChartTooltip 
//                     contentStyle={{ backgroundColor: '#0f172a', border: '1px solid #334155', borderRadius: '12px', color: '#fff', fontSize: '12px', fontWeight: 'bold', boxShadow: '0 10px 15px -3px rgba(0, 0, 0, 0.5)' }}
//                     formatter={(value) => [`Lệch ${Math.round(value)}% so với thói quen`, 'Mức độ cảnh báo']} 
//                   />
//                   <Radar name="Độ lệch (Z-Score)" dataKey="A" stroke="#f43f5e" strokeWidth={3} fill="#f43f5e" fillOpacity={0.6} />
//                 </RadarChart>
//               </ResponsiveContainer>
//             </div>

//             {/* ── AI INSIGHTS BẰNG CHỮ BÊN DƯỚI ──────────────── */}
//             <div>
//               <h5 className="text-xs font-black text-slate-500 uppercase tracking-widest mb-3">
//                 Báo cáo chi tiết từ AI
//               </h5>
...
//           <button
//             onClick={onClose}
//             className="px-10 py-3 bg-slate-900 hover:bg-black text-white font-black rounded-xl transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 text-sm uppercase tracking-widest"
//           >
//             Đóng bảng phân tích
//           </button>
//         </div>
...
// // ── Fallback khi backend chưa có AI Insights ────────────
