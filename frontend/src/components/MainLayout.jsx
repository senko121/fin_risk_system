...
//   // Đọc user để hiển thị Avatar trên Navbar
...
//   return (
//     <>
//       {/* ── NAVBAR BẤT TỬ SẼ NẰM Ở ĐÂY ── */}
//       <nav
//         className="flex items-center justify-between px-8 z-50 flex-shrink-0 shadow-sm"
//         style={{ background: '#0d1b2a', height: '60px' }}
//       >
//         <div className="flex items-center gap-3">
//           <div
//             className="flex items-center justify-center font-black text-white text-sm"
//             style={{ width: 34, height: 34, background: '#1a56db', borderRadius: 10, letterSpacing: '-0.5px' }}
//           >
//             FR
//           </div>
...
//             style={{ padding: '5px 12px 5px 5px', borderRadius: 99, background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.1)' }}
...
//             style={{ width: 34, height: 34, borderRadius: '50%', background: 'none', border: 'none', color: 'rgba(255,255,255,0.35)', cursor: 'pointer' }}
...
//       {/* ── NỘI DUNG TRANG (SẼ RENDER VÀ ANIMATION Ở ĐÂY) ── */}
  ...
  return (
    <div className="flex flex-col w-full h-full">
      ...
      {headerOverride ? (
        ...
        >
          {headerOverride.onBack && (
            <button
              ...
              className="absolute left-6 flex items-center justify-center transition-all"
        ...
        <nav
          className="flex items-center justify-between px-8 z-50 flex-shrink-0 shadow-sm transition-all duration-300"
          style={{ background: '#0d1b2a', height: '60px' }}
        >
          <div className="flex items-center gap-3">
