...
//   // 🚀 FIX: Fetch data ngay lập tức, không chờ set state currentUser nữa
//   useEffect(() => {
//     if (!currentUser) {
//       navigate('/login');
//       return;
//     }
//     fetchData(currentUser.id || currentUser.userId);
//   }, []); // Bỏ navigate ra khỏi deps, mảng rỗng để đảm bảo chạy đúng 1 lần
...
//   );
// }
// /* ── Skeletons Cao Cấp (Hiệu ứng Shimmer lướt sóng) ── */
// function RecentAvatarSkeleton() {
//   return (
//     <div className="flex flex-col items-center flex-shrink-0" style={{ gap: 10 }}>
//       {/* Khối Avatar */}
...
//       <div 
//         className="skeleton-shimmer"
//         style={{ height: 10, width: 48, borderRadius: 4, marginTop: 2 }}
//       ></div>
//     </div>
//   );
// }
...
//         </div>
//       </div>
//       {/* Khối Biến động số dư */}
//       <div 
//         className="skeleton-shimmer flex-shrink-0 ml-3" 
//         style={{ width: 80, height: 34, borderRadius: 10 }}
//       ></div>
//     </div>
//   );
// }