...
//   // =================================================================
//   // 🚀 LOGIC TÍNH TOÁN DỮ LIỆU BÁO CÁO (Đã bọc thép)
//   // =================================================================
...
//         // 1. Cộng dồn Tổng Thu / Tổng Chi
//         if (curr.type === 'CREDIT') {
//           totalIn += (curr.amount || 0);
//         } else {
//           totalOut += (curr.amount || 0);
//           expenseList.push(curr); // Lưu lại các khoản chi để tìm Top 3
//         }

//         // 2. Gom nhóm theo ngày cho Biểu đồ
...
//       // Lấy 7 ngày giao dịch gần nhất
//       const chartData = Object.values(groupedData).slice(-7);
      
//       // Tìm Top 3 giao dịch tốn kém nhất
...
//         {/* 🚀 KHU VỰC 1: 3 THẺ TỔNG QUAN (SUMMARY CARDS) */}
...
//           ) : chartData.length === 0 ? (
//             <div className="h-72 w-full flex items-center justify-center text-gray-400">Chưa có dữ liệu giao dịch để vẽ biểu đồ.</div>
//           ) : (
...
//                   <Bar dataKey="in" name="Tiền vào" fill="#10b981" radius={[6, 6, 0, 0]} barSize={32} />
//                   <Bar dataKey="out" name="Tiền ra" fill="#ef4444" radius={[6, 6, 0, 0]} barSize={32} />
//                 </BarChart>
//               </ResponsiveContainer>
//             </div>
//           )}
...
//         {/* 🚀 KHU VỰC 3: TOP GIAO DỊCH LỚN NHẤT */}
...
//                   <div className="flex items-center">
//                     <div className="w-10 h-10 bg-white text-red-500 font-black rounded-full flex items-center justify-center mr-4 shadow-sm border border-red-100">
//                       #{index + 1}
//                     </div>
//                     <div>
...
//                     <p className="font-black text-red-600">-{formatMoney(item.amount)}</p>
//                   </div>
//                 </div>
//               ))}
//             </div>
