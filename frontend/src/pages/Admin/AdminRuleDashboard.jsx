...
//   // 3.5. Mở Modal cho việc TẠO MỚI (Reset form)
...
//       value: ''
//     });
//     setEditingId(null); // Gán null để hệ thống biết đây là lệnh Tạo Mới
//     setIsModalOpen(true);
//   };
...
//   // 4. Lưu luật (Tạo mới hoặc Cập nhật)
//   const handleSaveRule = async () => {
//     const newConditionsJson = JSON.stringify({
//       field: formData.field,
//       operator: formData.operator,
...
//                     <option value="suspiciousSession">Phiên rủi ro IP (true/false)</option>
