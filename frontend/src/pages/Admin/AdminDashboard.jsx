      ...
      <div className="max-w-6xl mx-auto p-8 pb-16">
        ...
        <div className="border-t border-gray-200 pt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            {/* Emotion Override */}
            <Link
              to="/admin/emotion-override"
              className="bg-white border border-gray-100 rounded-xl p-5 flex items-center justify-between group transition-all hover:border-transparent hover:bg-red-600 hover:shadow-md"
            >
              <div>
                <p className="text-sm font-semibold text-gray-800 group-hover:text-white transition-colors">Emotion Override</p>
                <p className="text-xs text-gray-400 group-hover:text-white/60 mt-0.5 transition-colors">Ghi đè cảm xúc AI · Dev / QA</p>
              </div>
              <div className="w-10 h-10 bg-red-50 text-red-600 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-white/20 group-hover:text-white transition-all">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
